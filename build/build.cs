    ...
    .WithTask("test", b =>
    {
        b.WithDescription("dotnet test")
            ...
            .WithExecution(async () =>
            {
                ...
                {
                    await ExecuteCommandAsync($"dotnet test {project} --collect:'XPlat Code Coverage;Format=cobertura,opencover;ExcludeByAttribute=ExcludeFromCodeCoverage,Obsolete,GeneratedCode,CompilerGeneratedAttribute'");
                }
            })
            ;
    })
